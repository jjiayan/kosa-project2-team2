...
<%
    ...
    Long roomBoardId = 11L;
    
    // ⭐ 테스트할 사용자 선택 (2: 김철수, 3: 이영희, 4: 박민수, 5: 최지원, 6: 정수진)
    session.setAttribute("userId", 2L);
    
    // 현재 사용자 닉네임 가져오기
    String currentUser = "봄개발자";
    Long userId = (Long) session.getAttribute("userId");
    if (userId != null) {
        switch (userId.intValue()) {
            case 1: currentUser = "관리자"; break;
            case 2: currentUser = "봄개발자"; break;
            case 3: currentUser = "이영희"; break;
            case 4: currentUser = "박민수"; break;
            case 5: currentUser = "최지원"; break;
            case 6: currentUser = "정수진"; break;
        }
    }
%>
<!DOCTYPE html>
